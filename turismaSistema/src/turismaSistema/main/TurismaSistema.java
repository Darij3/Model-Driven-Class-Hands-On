...
/**
 * Entry point of the 'TurismaSistema' generation module.
 *
 * @generated
 */
public class TurismaSistema extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/turismaSistema/main/turismaSistema";
     ...
     * @generated
     */
    public TurismaSistema(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public TurismaSistema(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                TurismaSistema generator = new TurismaSistema(modelURI, folder, arguments);
